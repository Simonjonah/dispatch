                  ...
                  <tbody>
                    ...
                    @foreach ($view_abujaclubs as $view_abujaclub)
                      <tr>
                        ...
                        <td><a href="{{ url('admin/viewsclubstudent/'.$view_abujaclub->id) }}"
                            class='btn btn-default'>
                            <i class="far fa-eye"></i>
                        </a></td>
                   
                        <td><a href="{{ url('admin/editstudentclub/'.$view_abujaclub->id) }}"
                          class='btn btn-info'>
                      ...
                      <td><a href="{{ url('admin/deletestudentclub/'.$view_abujaclub->id) }}"
