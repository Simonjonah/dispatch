...
@include('dashboard.admin.sidebar')
  ...
  <div class="content-wrapper">
    ...
    @if ($addpsychomotoradmin->section == 'Early Years Foundation Stage (EYFS)')
                  ...
                  <form action="{{ url('web/createpsychomotoro1') }}" method="post">
                    ...
                    {{-- @method('PUT') --}}
                      <table class="table table-bordered">
                        ...
                        <td><input type="hidden" name="entrylevel" value="{{ $addpsychomotoradmin->entrylevel }}" id=""></td>
    ...
    @elseif ($addpsychomotoradmin->section == 'Primary')
