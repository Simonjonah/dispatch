      ...
      <div class="modal-body">
       ...
       <div class="form-group">
            ...
            <select name="regnumber"  class="form-control" id="">
              @foreach ($view_myresults as $view_myresult)
                <option value="{{ $view_myresult->regnumber }}">{{ $view_myresult->fname }} {{ $view_myresult->surname }} {{ $view_myresult->section }}  {{ $view_myresult->regnumber }}</option>
              @endforeach
            </select>
          ...
          <div class="form-group">
            ...
            @foreach ($view_myresults as $view_myresult)
                <option value="{{ $view_myresult->centername }}">{{ $view_myresult->centername }} </option>
              @endforeach
            </select>
      ...
      <div class="modal-body">
        <form action="{{ url('admin/searchforstudent') }}" method="post">
          ...
          <div class="form-group">
            ...
            <select name="sentername" required class="form-control" id="">
